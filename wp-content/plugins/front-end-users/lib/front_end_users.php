...
/* @see http://wordpress.org/support/topic/plugin-front-end-users-ajax-for-users-with-restricted-roles*/
class FrontEndUsers {
	...
	public function restrict_admin_access() {
		if (is_admin()) {
			$valid_admin_ajax_actions = array('user_avatar_add_photo', 'rio_ajax_rate', 'rio_ajax_more_posts', 'messageform_tags', 'messageform_submit');
